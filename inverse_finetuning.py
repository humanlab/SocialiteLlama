...
def find_examples_above_3k(dataset):
    ...
    return number_of_examples_greater_than_3000
...
if __name__ == '__main__':
    ...
    combined_train_dataset = load_and_tokenize_dataset("/chronos_data/gdey/datasets/socialite_instructions/inverse_instructions/train.csv", "csv")
    combined_val_dataset = load_and_tokenize_dataset("/chronos_data/gdey/datasets/socialite_instructions/inverse_instructions/val.csv", "csv")
    
    print("Training set details:")
    training_examples_above3k = find_examples_above_3k(combined_train_dataset)
    print("Validation set details:")
    validation_examples_above3k = find_examples_above_3k(combined_val_dataset)
    # exit()
    ...
    # combined_train_dataset = load_and_tokenize_dataset(args.dataset, "train")
    # combined_val_dataset = load_and_tokenize_dataset(args.dataset, "validation")
    combined_train_dataset = load_and_tokenize_dataset("/chronos_data/gdey/datasets/socialite_instructions/inverse_instructions/train.csv", "load")
    combined_val_dataset = load_and_tokenize_dataset("/chronos_data/gdey/datasets/socialite_instructions/inverse_instructions/val.csv", "load")
